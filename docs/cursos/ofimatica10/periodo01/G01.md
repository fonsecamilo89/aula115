...
```{tab-item} Recursos (1)
- [TEXTO: Introducción a la Ofimática](../recursos/T01.md)
```
:::
...
---
## A02: Análisis de casos (+0,1)
{bdg-info}`Estructuración`

1. Escriba en su cuaderno los siguientes casos y al final de cada uno, indique que **área de trabajo** de la ofimática corresponde y explique por que.
