...
[^1] Un algoritmo es un conjunto de **instrucciones** que le dicen a un ser humano COMO REALIZAR una tarea específica, dichas instrucciones pueden estar escritas en código o lenguaje natural.
...
- **FASE 03: Construcción del algoritmo (código fuente)**
    ...
    Conversión del **diagrama de flujo** a **CÓDIGO FUENTE**.
...
---
## Algoritmo para ir al colegio (ejemplo)

Desarrolle el siguiente ejercicio:

:::{dropdown} Algoritmo para ir al colegio
...
:::{admonition} (Objetivo y condiciones)
:class: tip 
...
```python
 ...
 1. Ponerse el uniforme
 3. Ir al garaje
 4. Intentar prender la moto
 5. Si (la moto SI prende)
     5.1 Abrir el garaje
     5.2 Sacar la moto
     5.3 Cerrar el garaje
     5.4 Conducir hasta el colegio
 6. Si (la moto NO prende)
     6.1 Salir del garage
     6.2 Salir de la casa
     6.3 Cerrar la puerta
     6.4 Caminar hasta el colegio
 7. Llegar al colegio
